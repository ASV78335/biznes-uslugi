...
var accordion = function accordion(block) {
  var headers = document.querySelectorAll(block);
...
var buttons = function buttons() {
  var btnPopup = document.querySelectorAll('.btn_popup'),
...
var calc = function calc() {
  var inputType = document.querySelectorAll('input[name="type"]'),
  ...
  var calcFunc = function calcFunc() {
    ...
    var _iterator = _createForOfIteratorHelper(inputType),
        _step;
    ...
    var _iterator2 = _createForOfIteratorHelper(inputForm),
        _step2;
    ...
    var _iterator3 = _createForOfIteratorHelper(inputSNO),
        _step3;
    ...
    ;
    sum = Math.round(+valueType * +valueForm * +valueSNO * (+inputDoc.value * 50 + inputPerson.value * 1000) + +valueRAR + +valueDMDK);
    console.log(valueType, valueForm, valueSNO, inputDoc.value, inputPerson.value, valueRAR, valueDMDK);
    if (sum == 0) sum = 1000;
    result.innerHTML = sum;
  };

  var _iterator4 = _createForOfIteratorHelper(inputType),
      _step4;
  ...
  var _iterator5 = _createForOfIteratorHelper(inputForm),
      _step5;
  ...
  try {
    for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
      ...
      _item3.addEventListener('change', calcFunc);
    }
  } catch (err) {
    _iterator5.e(err);
  } finally {
  ...
  var _iterator6 = _createForOfIteratorHelper(inputSNO),
      _step6;
  ...
  try {
    for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
      ...
      _item4.addEventListener('change', calcFunc);
    }
  } catch (err) {
    _iterator6.e(err);
  } finally {
...
var menu = function menu() {
  ...
  var menuFL = document.getElementById('menu-fl');
  var subMenuUL = document.getElementById('submenu-ul');
  var subMenuFL = document.getElementById('submenu-fl');
  var subMenuUlItems = document.querySelectorAll('.submenu-ul__items');
  var subMenuFlItems = document.querySelectorAll('.submenu-fl__items');
...
var slider = function slider(selector, prev, next) {
...
var time = function time(timeIndicator, timeInfo) {
  var indicator = document.querySelectorAll(timeIndicator),
  ...
  var dayWeek = [7, 1, 2, 3, 4, 5, 6][curTime.getDay()]; // Перевести часы работы в часовой пояс посетителя
